...
export const metadata: Metadata = {
  title: "Transcription Billing & Credit Balance | KreyAI",
  description:
  ...
  alternates: {
    canonical: "/transcription/billing",
  },
  openGraph: {
    title: "KreyAI Transcription Billing & Credit Balance",
    description:
      "Manage prepaid transcription credits and review billing terms for KreyAI audio transcription.",
    url: "/transcription/billing",
    ...
    <main className="page-shell text-neutral-900">
      <section className="page-wrap-narrow">
        <div className="page-header">
          <p className="page-eyebrow">Transcription Billing</p>
          <h1 className="page-title">KreyAI Transcription Billing</h1>
          <p className="page-lede">
            Buy prepaid transcription credits, check your minute balance, and review how transcription billing works.
          </p>
