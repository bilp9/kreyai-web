    ...
    <main className="relative min-h-screen bg-neutral-50 text-neutral-900 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-[-200px] right-[-200px] w-[600px] h-[600px] 
                        bg-gradient-to-br from-indigo-400/30 via-pink-400/20 to-purple-400/30 
                        rounded-full blur-3xl" />

        <div className="absolute bottom-[-150px] left-[-150px] w-[500px] h-[500px] 
                        bg-gradient-to-tr from-blue-400/20 via-purple-300/20 to-pink-300/20 
                        rounded-full blur-3xl" />
      ...
      <div className="mx-auto max-w-6xl px-6 py-32 space-y-40">
        ...
        <section className="grid md:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="pt-6 flex gap-4">
              ...
              <input
                ...
                className="flex-1 rounded-xl bg-white border border-neutral-300 px-4 py-3 text-neutral-900 focus:outline-none focus:ring-2 focus:ring-neutral-900"
              />

              <button
                onClick={startJob}
                disabled={loading}
                className="rounded-xl bg-neutral-900 px-6 py-3 text-base font-medium text-white hover:bg-black transition"
              >
          ...
          <div className="relative">
            ...
            <div className="rounded-2xl border border-neutral-200 bg-white p-8 space-y-6 shadow-xl">
              ...
              <div className="flex justify-between text-sm text-neutral-500 pt-4">
                <span>Speaker 2</span>
                <span>00:12</span>
              </div>
