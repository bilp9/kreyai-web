...
export const metadata: Metadata = {
  title: "aTelier 0.1.2 Release Notes | KreyAI",
  description:
    "Release notes for aTelier 0.1.2, a local-first CAT tool for translators.",
  alternates: {
    canonical: "/atelier/releases/0.1.2",
  },
};

const NOTES = [
  "Packaged app now defaults to trial/licensed mode instead of developer mode.",
  "License Settings no longer displays developer credentials or raw local license keys.",
    ...
    <main className="page-shell text-[#13172b]">
      <section className="page-wrap-narrow">
        <div className="page-header">
          ...
          <h1 className="page-title">aTelier 0.1.2</h1>
          <p className="page-lede">
            Early-access update for macOS. This release fixes packaged licensing display, removes developer-mode leakage,
            and keeps update checks clear and bounded.
          </p>
        </div>
